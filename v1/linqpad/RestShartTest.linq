...
void Main()
{
	...
	var client = new RestClient("https://members.iracing.com/membersite");
	client.Authenticator = new HttpBasicAuthenticator(username, password);
	var response = client.Post(new RestRequest("login", DataFormat.None));
	
	
	
	
	
	var iracing = new iRacingScraperService();
	var cookies = iracing.LoginAndGetCookies();
